...
MODEL_NAME = 'MobileNetV3Small_model' # NASNetLarge, MobileNetV3Large, MobileNetV3Small
...
last_output = MobileNetV3Small_model.output
x = tf.keras.layers.Flatten()(last_output)
x = tf.keras.layers.Dense(1024, activation='relu')(x)
output_layer = tf.keras.layers.Dense(no_classes, activation='softmax')(x)
model = tf.keras.Model(inputs=MobileNetV3Small_model.input, outputs=output_layer)
