...
plt.xlabel('epoch')
# plt.show()
plt.savefig(BASE_DIR+"/plots/"+MODEL_NAME+"_BatchSize_"+str(batch_size)+"_"+str(validation_split)+"ValSplit_"+str(dt_string)+'.png')
...
saved_model_path = BASE_DIR+"/saved_models/"+MODEL_NAME+"_BatchSize_"+str(batch_size)+"_"+str(validation_split)+"ValSplit_"+str(dt_string)
tf.saved_model.save(model, saved_model_path)

# Saving the model task graphs
dot_img_file = BASE_DIR+"/model_graphs/"+MODEL_NAME+"_BatchSize_"+str(batch_size)+"_"+str(validation_split)+"ValSplit_"+str(dt_string)+'.png'
